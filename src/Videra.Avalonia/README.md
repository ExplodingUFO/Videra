...
- Keep runtime coordination internal while `SceneDocument` carries public scene-entry truth through `SceneDocumentEntry`, `ModelLoadResult.Entry`, and `ModelLoadResult.Entries`
