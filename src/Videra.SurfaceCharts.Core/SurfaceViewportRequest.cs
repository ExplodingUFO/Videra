...
public readonly record struct SurfaceViewportRequest
{
    ...
    /// </summary>
    /// <param name="metadata">The dataset metadata.</param>
    /// <param name="dataWindow">The requested data window.</param>
    /// <param name="outputWidth">The output width in pixels.</param>
    /// <param name="outputHeight">The output height in pixels.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="metadata"/> or <paramref name="dataWindow"/> is <c>null</c>.</exception>
    /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="outputWidth"/> or <paramref name="outputHeight"/> is not positive.</exception>
    ...
    /// <summary>
    /// Gets the requested data window.
    /// </summary>
    public SurfaceDataWindow DataWindow { get; }

    /// <summary>
    /// Gets the requested viewport compatibility view of the data window.
    /// </summary>
    public SurfaceViewport Viewport => SurfaceViewport.FromDataWindow(DataWindow);
    ...
    /// </summary>
    public SurfaceViewport ClampedViewport => SurfaceViewport.FromDataWindow(ClampedDataWindow);
