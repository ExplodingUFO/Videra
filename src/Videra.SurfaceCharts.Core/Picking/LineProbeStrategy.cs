...
/// <summary>
/// Resolves probes for line series by finding the nearest line segment within a configurable snap radius.
/// </summary>
public sealed class LineProbeStrategy : ISeriesProbeStrategy
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LineProbeStrategy"/> class.
    /// </summary>
    /// <param name="scene">The line render scene to probe.</param>
    /// <param name="snapRadius">The maximum XZ distance from a line segment to trigger a probe hit. Defaults to 0.05.</param>
    ...
    public SurfaceProbeInfo? TryResolve(double chartX, double chartZ, SurfaceMetadata metadata)
    {
        ...
        if (nearestIndex < 0 || minDist > _snapRadius)
        {
            return null;
        }
