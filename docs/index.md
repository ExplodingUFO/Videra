...
This page maps the long-lived public documentation for Videra. Start with the repository README when you need the public package boundary, chart-package truth, or the current alpha support contract for the shipped `SurfaceChartView`, `WaterfallChartView`, and `ScatterChartView` controls.
