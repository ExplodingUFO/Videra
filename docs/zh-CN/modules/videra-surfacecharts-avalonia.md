...
- `ScatterChartView` 暴露 `InteractionQuality`、retained point count、append/replacement batch count、FIFO dropped points、configured FIFO capacity 与 pickable point count
