...
- `VideraChartView` follows the same chart-local interaction-quality terminology for its Plot.Add.Scatter path and reports that state through `ScatterChartRenderingStatus`.
