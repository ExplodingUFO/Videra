...
public sealed class SurfaceChartInteractionTests
{
    ...
    public Task LeftDrag_Orbits_ViewStateCamera()
    {
        return AvaloniaHeadlessTestSession.RunAsync(async () =>
        {
            ...
            view.ViewState.Camera.YawDegrees.Should().NotBeApproximately(initialState.Camera.YawDegrees, 0.0001d);
            view.ViewState.Camera.PitchDegrees.Should().NotBeApproximately(initialState.Camera.PitchDegrees, 0.0001d);
        });
    }

    [Fact]
    public Task RightDrag_Pans_ViewStateDataWindow()
    {
        return AvaloniaHeadlessTestSession.RunAsync(async () =>
        {
            var source = new ScriptedSurfaceTileSource(SurfaceChartViewLifecycleTests.CreateMetadata(), defaultTileValue: 11f);
            ...
            view.ViewState.DataWindow.StartX.Should().BeLessThan(initialState.DataWindow.StartX);
