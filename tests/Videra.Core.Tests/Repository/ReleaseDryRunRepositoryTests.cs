...
public sealed class ReleaseDryRunRepositoryTests
{
    ...
    public void ReleaseReadinessValidationScript_ShouldComposeV257LocalGateAndStayNonPublishing()
    {
        ...
        script.Should().Contain("SurfaceChartsCookbookCoverageMatrixTests");
        script.Should().Contain("SurfaceChartsCookbookFirstSurfaceRecipeTests");
        script.Should().Contain("SurfaceChartsCookbookWaterfallLinkedRecipeTests");
        script.Should().Contain("SurfaceChartsCookbookScatterLiveRecipeTests");
        script.Should().Contain("SurfaceChartsCookbookBarContourSnapshotRecipeTests");
        script.Should().Contain("SurfaceChartsHighPerformancePathTests");
        script.Should().Contain("ScatterStreamingScenarioEvidenceTests");
        script.Should().Contain("SurfaceChartsPerformanceTruthTests");
        script.Should().Contain("BeadsPublicRoadmapTests");
        script.Should().Contain("SurfaceChartsCiTruthTests");
        script.Should().Contain("ReleaseDryRunRepositoryTests");
        script.Should().Contain("SurfaceChartsReleaseTruthRepositoryTests");
        ...
        script.Should().NotContain("ConsumerSmokeBuildOnly");
        script.Should().NotContain("-BuildOnly");
