...
public sealed class RepositoryReleaseReadinessTests
{
    ...
    public void CanonicalViewerPackageStackDocs_ShouldShareSameBoundaryAndInstallStory()
    {
        ...
        packageMatrix.Should().Contain("Try next: Analytics proof");
        ...
        releasePolicy.Should().Contain("Try next: Analytics proof");
        ...
        releasing.Should().Contain("Try next: Analytics proof");
    ...
    public void ProductBoundaryDocs_ShouldPublishCapabilityAndLayerMatrices()
    {
        ...
        capabilityMatrix.Should().Contain("bounded renderer-consumption seam rather than a broader lighting/shader/backend promise");
    ...
    public void SurfaceChartsReleaseBoundaryDocs_ShouldKeepSourceFirstTruthExplicit()
    {
        ...
        supportMatrix.Should().Contain("Try next: Analytics proof");
