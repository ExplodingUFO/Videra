...
public sealed class RepositoryArchitectureTests
{
    ...
    public void StaticGltfPbrDocs_ShouldDescribeBaselineAndDeliberateExclusions()
    {
        ...
        const string PackageMatrixNonGoalsSentence =
            "`animation`, `skeletons`, `morph targets`, broader lighting systems beyond the bounded broader-lighting baseline, `shadows`, `environment maps`, `post-processing`, `extra UI adapters`, and `Wayland/OpenGL/WebGL/backend API expansion` stay outside the current product promise.";
        ...
        const string DirectLightingBaselineSentence =
            "bounded style-driven broader-lighting baseline";
