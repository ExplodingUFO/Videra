...
/// <summary>
/// Provides sample data creation methods for demo recipes.
/// </summary>
public static class SampleDataFactory
{
    public static ISurfaceTileSource CreateInMemorySource()
    {
        var matrix = CreateSampleMatrix();
        return new SurfacePyramidBuilder(32, 32).Build(matrix);
    }

    public static ISurfaceTileSource CreateAnalyticsProofSource()
    {
    ...
    public static ISurfaceTileSource CreateWaterfallSource()
    {
    ...
    public static BarChartData CreateSampleBarData()
    {
    ...
    public static ContourChartData CreateSampleContourField()
    {
        const int size = 32;
    ...
    public static ScatterChartData CreateSampleScatterData()
    {
        var points = new ScatterPoint[50];
        ...
        var metadata = new ScatterChartMetadata(
            new SurfaceAxisDescriptor("X", "u", -10d, 10d),
            new SurfaceAxisDescriptor("Z", "u", -10d, 10d),
            new SurfaceValueRange(-10d, 10d));
        return new ScatterChartData(metadata, [new ScatterSeries(points, 0xFF38BDF8u, "Scatter")]);
    }

    public static double[] CreateSampleLineXs()
    {
        const int count = 30;
    ...
    public static double[] CreateSampleLineYs()
    {
        const int count = 30;
    ...
    public static double[] CreateSampleLineZs()
    {
        const int count = 30;
    ...
    public static double[] CreateSampleVectorFieldXs()
    {
    ...
    public static double[] CreateSampleVectorFieldYs()
    {
        const int gridSize = 6;
    ...
    public static double[] CreateSampleVectorFieldZs()
    {
        const int gridSize = 6;
    ...
    public static double[] CreateSampleVectorFieldDxs()
    {
        const int gridSize = 6;
    ...
    public static double[] CreateSampleVectorFieldDys()
    {
        const int gridSize = 6;
    ...
    public static double[] CreateSampleVectorFieldDzs()
    {
        const int gridSize = 6;
    ...
    public static double[,] CreateSampleHeatmapValues()
    {
        const int size = 24;
    ...
    public static BoxPlotData CreateSampleBoxPlotData()
    {
    ...
    public static double[] CreateSampleHistogramValues()
    {
    ...
    public static SurfaceColorMap CreateColorMap(SurfaceValueRange range)
    {
    ...
    public static ScatterChartData CreateScatterSource(ScatterStreamingScenario scenario)
    {
    ...
    private static SurfaceMatrix CreateAnalyticsProofMatrix()
    {
        ...
        {
            0.0d, 0.14d, 0.33d, 0.54d, 0.88d, 1.19d, 1.55d, 1.96d, 2.41d,
            2.96d, 3.34d, 3.88d, 4.31d, 4.91d, 5.45d, 6.05d, 6.74d, 7.68d, 8.52d,
        };

        var verticalCoordinates = new double[]
        {
            -1.1d, -0.68d, -0.22d, 0.09d, 0.35d, 0.66d, 1.02d,
            1.41d, 1.85d, 2.31d, 2.92d, 3.48d, 4.14d,
        };
